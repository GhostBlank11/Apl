...
class Config {
  ...
  /// Generated by SiteNative 04-02-2023 08:25:42
  /// App UID: 94539e22-3658-9c4c-8efa-0a296e2684b5
  /// Version: https://convert.serverku.tech/backend/
  /// API server: {VERSION}
  ...
  // Admin email
  static String appEmail = "admin@serverku.tech";
  // Template
  ...
  // Signing
  static String osSigning = "c7dd822de21b4776604fdffaf55c36b6bc3dc0a0ad4f868e7b1502069de4aa83";
  // Enabled android?
  ...
  static List<NavigationItem> mainNavigation = [
    	NavigationItem(name: "Halllo",icon: "albums-outline.svg",type: ActionType.internal,value: "Https://google.com/",),

  ];
  // Bar app navigation
  static List<NavigationItem> barNavigation = [
    	NavigationItem(name: "Thcz",icon: "albums-outline.svg",type: ActionType.internal,value: "https://google.com",),
